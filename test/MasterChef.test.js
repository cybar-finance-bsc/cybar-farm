...
contract('MasterChef', ([alice, bob, carol, dev, minter]) => {
    beforeEach(async () => {
        ...
        this.chef = await MasterChef.new(this.cybar.address, this.dyce.address, dev, '1000', '100', { from: minter });
    ...
    it('update multiplier', async () => {
      ...
      await this.cybar.approve(this.chef.address, '100', { from: alice });
      await this.cybar.approve(this.chef.address, '100', { from: bob });
